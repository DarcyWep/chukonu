...
func NewTransaction(hash *common.Hash, amount int64, from, to []byte, payload Payload) *Transaction {
	...
	tx.ID = tx.Hash()
	tx.DropHash = common.BytesToHash(common.CopyBytes(hash.Bytes()))
